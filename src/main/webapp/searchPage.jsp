...
<div class="main">
	...
	<section class="sideProduct"> <jsp:include page="search/mainSidebar.jsp"/> </section>
	<section style="height: auto; float: left; width: 80%"><jsp:include page="search/searchPage.jsp"/>
	</section>
	<div class="paging">
