...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
MemberBin mem = (MemberBin) request.getAttribute("member");
if (mem == null) {
	...
	<div>
		...
		<table class="table" style="width: 600px; margin-top: 30px;">
			<tr >
				<td>아이디</td>
				<td colspan="2">
					<input type="text" name="id" class="form-control" value="<%=mem.getId()%>" id="_id" readonly="readonly">
				</td>
			</tr>
			<tr>
				<td >비밀번호</td>
			...
			<tr>
				<td >주소</td>
				<td ><input type="text" name="nAd" class="form-control" readonly="readonly" value="<%=mem.getnAd()%>" id="_nAd"></td>
				<td align="center"><button type="submit" class="btn btn-primary" onclick="openPopup('address.jsp'); return false;">검색</button></td>
			</tr>
			<tr>
				<td colspan="3"><input type="text" name="address" class="form-control" readonly="readonly" value="<%=mem.getAddress()%>" id="_address"></td>
			</tr>
			<tr>
				<td>상세주소</td>
				<td ><input type="text" name="dAd" class="form-control" value="<%=mem.getdAd()%>" id="_dAd"></td>
